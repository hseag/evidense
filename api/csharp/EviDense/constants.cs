...
public class Dict
{
    ...
    /// JSON key 'A230'.
    /// </summary>
    public const string A230 = "A230";

    /// <summary>
    /// JSON key 'A260'.
    /// </summary>
    public const string A260 = "A260";

    /// <summary>
    /// JSON key 'A280'.
    /// </summary>
    public const string A280 = "A280";

    /// <summary>
    /// JSON key 'A340'.
    /// </summary>
    public const string A340 = "A340";
    ...
    /// <summary>
    /// JSON key 'centerwavelengths'.
    /// </summary>
    public const string CENTER_WAVELENGTHS = "centerwavelengths";

    /// <summary>
    /// JSON key 'adjustments'.
    /// </summary>
    ...
    /// <summary>
    /// JSON key 'parameters_run'.
    /// </summary>
    public const string PARAMETERS = "parameters_run";

    /// <summary>
    /// JSON key 'nr_of_blanks'.
    /// </summary>
    public const string NR_OF_BLANKS = "nr_of_blanks";
    ...
    /// <summary>
    /// JSON key 'f_a_buffer_blank'.
    /// </summary>
    public const string BUFFER_BLANK = "f_a_buffer_blank";

    public const string BASELINE_230_REFERENCE = $"{BASELINE} {CH_230} {REFERENCE}";
    public const string BASELINE_230_SAMPLE = $"{BASELINE} {CH_230} {SAMPLE}";
    public const string BASELINE_260_REFERENCE = $"{BASELINE} {CH_260} {REFERENCE}";
    public const string BASELINE_260_SAMPLE = $"{BASELINE} {CH_260} {SAMPLE}";
    public const string BASELINE_280_REFERENCE = $"{BASELINE} {CH_280} {REFERENCE}";
    public const string BASELINE_280_SAMPLE = $"{BASELINE} {CH_280} {SAMPLE}";
    public const string BASELINE_340_REFERENCE = $"{BASELINE} {CH_340} {REFERENCE}";
    public const string BASELINE_340_SAMPLE = $"{BASELINE} {CH_340} {SAMPLE}";

    public const string AIR_230_REFERENCE = $"{AIR} {CH_230} {REFERENCE}";
    public const string AIR_230_SAMPLE = $"{AIR} {CH_230} {SAMPLE}";
    public const string AIR_260_REFERENCE = $"{AIR} {CH_260} {REFERENCE}";
    public const string AIR_260_SAMPLE = $"{AIR} {CH_260} {SAMPLE}";
    public const string AIR_280_REFERENCE = $"{AIR} {CH_280} {REFERENCE}";
    public const string AIR_280_SAMPLE = $"{AIR} {CH_280} {SAMPLE}";
    public const string AIR_340_REFERENCE = $"{AIR} {CH_340} {REFERENCE}";
    public const string AIR_340_SAMPLE = $"{AIR} {CH_340} {SAMPLE}";

    public const string SAMPLE_230_REFERENCE = $"{SAMPLE} {CH_230} {REFERENCE}";
    public const string SAMPLE_230_SAMPLE = $"{SAMPLE} {CH_230} {SAMPLE}";
    public const string SAMPLE_260_REFERENCE = $"{SAMPLE} {CH_260} {REFERENCE}";
    public const string SAMPLE_260_SAMPLE = $"{SAMPLE} {CH_260} {SAMPLE}";
    public const string SAMPLE_280_REFERENCE = $"{SAMPLE} {CH_280} {REFERENCE}";
    public const string SAMPLE_280_SAMPLE = $"{SAMPLE} {CH_280} {SAMPLE}";
    public const string SAMPLE_340_REFERENCE = $"{SAMPLE} {CH_340} {REFERENCE}";
    public const string SAMPLE_340_SAMPLE = $"{SAMPLE} {CH_340} {SAMPLE}";
...
public enum Index
{
    ...
    /// <summary>
    /// Index for center wavelength 230 nm LED in pm.
    /// </summary>
    ...
    /// <summary>
    /// Index for center wavelength 260 nm LED in pm.
    /// </summary>
    ...
    /// <summary>
    /// Index for center wavelength 280 nm LED in pm.
    /// </summary>
    ...
    /// <summary>
    /// Index for center wavelength 340 nm LED in pm.
    /// </summary>
