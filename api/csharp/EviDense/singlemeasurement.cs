    ...
    Channel? channel340 = null)
{
    ...
    /// </summary>
    public Channel Channel230 { get; set; } = channel230 ?? new Channel();

    /// <summary>
    /// Gets or sets the channel for 260 nm measurements.
    /// </summary>
    public Channel Channel260 { get; set; } = channel260 ?? new Channel();

    /// <summary>
    /// Gets or sets the channel for 280 nm measurements.
    /// </summary>
    public Channel Channel280 { get; set; } = channel280 ?? new Channel();

    /// <summary>
    /// Gets or sets the channel for 340 nm measurements.
    /// </summary>
    public Channel Channel340 { get; set; } = channel340 ?? new Channel();
