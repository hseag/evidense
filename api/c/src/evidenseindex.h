...
enum EviDenseIndices
{
    ...
    INDEX_LED230NM_CENTER_WAVE_LENGTH             = 24,
    INDEX_LED260NM_CENTER_WAVE_LENGTH             = 34,
    INDEX_LED280NM_CENTER_WAVE_LENGTH             = 44,
    INDEX_LED340NM_CENTER_WAVE_LENGTH             = 54,
